...
public class MainActivityHistory_three extends ActionBarActivity {
    ...
    SQLitemenudb_three db = new SQLitemenudb_three(MainActivityHistory_three.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_history_three);
	...
	private void listviewupdate() {
		...
		SimpleAdapter adapter = new SimpleAdapter(
				MainActivityHistory_three.this, r1,
