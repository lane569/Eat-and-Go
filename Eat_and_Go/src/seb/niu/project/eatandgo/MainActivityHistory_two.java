...
public class MainActivityHistory_two extends ActionBarActivity {
    ...
    SQLitemenudb_two db = new SQLitemenudb_two(MainActivityHistory_two.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_history_two);
	...
	private void listviewupdate() {
		...
		SimpleAdapter adapter = new SimpleAdapter(
				MainActivityHistory_two.this, r1,
