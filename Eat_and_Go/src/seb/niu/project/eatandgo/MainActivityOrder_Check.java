...
public class MainActivityOrder_Check extends ActionBarActivity {

	Button btn_next;
	TextView tv_check;
	SQLitemenudb_one db = new SQLitemenudb_one(MainActivityOrder_Check.this);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_activity_order_one_check);
		...
		btn_next.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(MainActivityOrder_Check.this,
						MainActivityOrderFinish.class);
				startActivity(intent);
				MainActivityOrder_Check.this.finish();
			}
		});
