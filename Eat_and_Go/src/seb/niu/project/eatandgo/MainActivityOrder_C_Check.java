...
public class MainActivityOrder_C_Check extends ActionBarActivity {

	Button btn_next;
	TextView tv_check;
	SQLitemenudb_four db = new SQLitemenudb_four(MainActivityOrder_C_Check.this);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_activity_order_four_check);
		...
		btn_next.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(MainActivityOrder_C_Check.this,
						MainActivityOrderFinish.class);
				startActivity(intent);
				MainActivityOrder_C_Check.this.finish();
			}
		});
