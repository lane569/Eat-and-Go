...
public class MainActivityHistory_four extends ActionBarActivity {
    ...
    SQLitemenudb_four db = new SQLitemenudb_four(MainActivityHistory_four.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_history_four);
	...
	private void listviewupdate() {
		...
		SimpleAdapter adapter = new SimpleAdapter(
				MainActivityHistory_four.this, r1,
