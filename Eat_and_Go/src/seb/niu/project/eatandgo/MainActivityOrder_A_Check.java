...
public class MainActivityOrder_A_Check extends ActionBarActivity {

	Button btn_next;
	TextView tv_check;
	SQLitemenudb_two db = new SQLitemenudb_two(MainActivityOrder_A_Check.this);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_activity_order_two_check);
		...
		btn_next.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(MainActivityOrder_A_Check.this,
						MainActivityOrderFinish.class);
				startActivity(intent);
				MainActivityOrder_A_Check.this.finish();
			}
		});
